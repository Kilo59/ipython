...
def test_history():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            ip.run_line_magic("hist", f'-f {tmp_path / "test1"}')
            ip.run_line_magic("hist", f'-pf {tmp_path / "test2"}')
            ip.run_line_magic("hist", f'-nf {tmp_path / "test3"}')
            ip.run_line_magic("save", f'{tmp_path / "test4"} 1-10')
            ...
            ip.run_line_magic("save", f"{str(testfilename)} ~1/1-3")
